...
describe("PanelManager", () => {
  ...
  it("sets iframe src in webview html", async () => {
    ...
    expect(capturedHtml).toContain('src="http://127.0.0.1:9999/review?id=42"');
    expect(capturedHtml).toContain("acr-ready");
  });
  ...
  it("uses asExternalUri resolved URL in iframe and CSP", async () => {
    ...
    expect(capturedHtml).toContain('src="https://localhost:8443/review?id=42"');
